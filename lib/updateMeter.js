...
updateMeter.handleFiveMinutes = function() {
    ...
    var that = this;
    return that._getRangeFromDb('minutes', 5).then(function(data) {
...
updateMeter.handleHalfHour = function() {
    ...
    var that = this;
    return that._getRangeFromDb('minutes', 30).then(function(data) {
        that.db.rpush("halfHour", JSON.stringify(data));
        logger.info("  Inserted data into halfHour:", data);
...
updateMeter.handleHour = function() {
    ...
    var that = this;
    return that._getRangeFromDb('minutes', 60).then(function(data) {
        that.db.rpush('hours', JSON.stringify(data));
        logger.info("  Inserted data into hours");
        return data;
    });
};
