...
class ConfigParser {
  ...
  overrideWithEnv() {
    ...
    if (typeof process.env.POWER_METER_INTERVAL !== 'undefined') {
      this.interval = process.env.POWER_METER_INTERVAL;
    }

    if (typeof process.env.POWER_METER_IMPS !== 'undefined') {
      this.impsPerKwh = process.env.POWER_METER_IMPS;
    }
  }
}
